...
function setup() {
	...
	rope2=new Rope(bob2,roof,-90+45,0);
	rope3=new Rope(bob3,roof,-90+90,0);
	rope4=new Rope(bob4,roof,-90+135,0);
	rope5=new Rope(bob5,roof,-90+180,0);
...
//ropes
  ...
  pop ();
	...
	textStyle(BOLD);
	textSize(30);
	text('Press the UP_ARROW',width/2-160,height-100);
	pop();
	...
	textStyle(BOLD);
	textSize(30);
	text("NEWTON'S CRADLE",width/2-145,60);
	pop();
}
